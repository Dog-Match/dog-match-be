...
const { getScoresFromProfile, getTemperamentsFromResults, getBreedsFromTemperaments } = require('./recommendations-utils.js');
...
app.get('/api/recommendations', async(req, res) => {
  try {
    ...
    const temprs = getTemperamentsFromResults(scores);
    const breeds = getBreedsFromTemperaments(temprs);
...
app.get('/api/breed-details', async(req, res)=> {
  try{
