...
async function ensureProfile(req, res, next) {
  ...
  // if you include this call, you can use this function as express middleware
  next();

  // i mean, not here, since it wouldn't work when you rely on this return value, but if you ever write middleware in the future
